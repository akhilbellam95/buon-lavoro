...
import logo1 from "@/images/buon-logo.png";
...
const navItems = [
  ...
  // },
  {
    ...
    subNavItems: [
      ...
      { id: 2, name: "Website Development", href: "/web-development" },
      { id: 3, name: "App Development", href: "/app-development" },
      { id: 4, name: "Graphic Designing", href: "/graphic-designing" },
      { id: 5, name: "Digital Marketing", href: "/digital-marketing" },
      // { id: 7, name: "SEO & Content Writing", href: "/seo" },
      { id: 6, name: "UI/UX Designing", href: "/ui-designing" },
      { id: 7, name: "E-Book Conversion", href: "/e-book-conversion" },
    ],
  },
  // {
  //   id: 5,
...
const headerData = {
  ...
  navItemsTwo,
  address:
    "101, The Waterfront, Timber Lake Colony, Rai Durg, Hydereabad - 500032",
  phone: "958 109 8888",
  phone2: "+91 958 109 8888",
